...
HD_LIBRARY_SRC_cxx	= lpack_wrapperapec.cxx \
			  wrapperapecFunctionMap.cxx

HD_LIBRARY_SRC_cpp	= wrapper.cpp
...
HD_CXXFLAGS		= ${HD_STD_CXXFLAGS} \
			  ...
			  -I/home/avalderr/.local/lib/python3.9/site-packages/numpy/core/include \
			  -DINITPACKAGE
...
HD_SHLIB_LIBS           = ${HD_LFLAGS} -l${CCFITS} -l${CFITSIO} -lXS \
			  ...
			  -lpython3.9 -L/usr/lib/python3.9/config-3.9-x86_64-linux-gnu \
